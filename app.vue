<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-violet-800 py-6 flex flex-col justify-center sm:py-12">
    <div class="relative py-3 sm:max-w-xl sm:mx-auto">
      <!-- Carte visuelle avec effet glassmorphism -->
      <div class="relative group">
        ...
        <div class="relative w-96 h-56 rounded-xl shadow-2xl overflow-hidden backdrop-blur-sm transition-all duration-500 transform hover:scale-105"
             :class="[
          ...
          <!-- Logo de la carte avec effet de brillance -->
          ...
          <!-- Numéro de carte avec effet de brillance -->
...
const validateCardHolder = () => {
  if (cardHolder.value.trim().length < 3) {
    errors.value.cardHolder = 'Nom invalide'
  } else {
